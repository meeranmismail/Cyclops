...
.loadCyclopsDataY <- function(x, stratumId, rowId, y, starttime, endtime) {
    invisible(.Call('Cyclops_cyclopsLoadDataY', PACKAGE = 'Cyclops', x, stratumId, rowId, y, starttime, endtime))
}
